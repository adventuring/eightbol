    ...
    (:shift-right
     ...
     (:dialogue
      (let ((text (getf (rest stmt) :text))
        ...
        (format out "~&~8tmovs    r0, #DialogueID_~a"
                (normalize-identifier-to-pascal-case text))
        ;; Set speaker register (R1 holds speaker ID)
        (format out "~&~8tmovs    r1, #~a" (normalize-identifier-to-pascal-case speaker))
        ;; Call dialogue dispatcher
        (format out "~&~8tbl      DoDialogue~%")))
     (:print
