...
(defun z80-symbol (name)
 "Convert EIGHTBOL identifier to Z80 assembly symbol (PascalCase)."
...
(defun compile-z80-method (out method class-id slot-table type-table const-table pic-size-table pic-width-table)
 ...
 (compile-z80-statement out stmt class-id slot-table type-table const-table pic-size-table pic-width-table))
 (format out "~&~10tret")))
...
(defun compile-z80-load (out expr class-id slot-table const-table pic-width-table &optional (width (operand-width expr pic-width-table)))
 ...
 ((and (stringp expr) (constant-p expr const-table))
 (if (= (or width 1) 2)
 (format out "~&~10tld hl, #~d" (constant-value expr const-table))
 (format out "~&~10tld a, ~d" (constant-value expr const-table))))
 ((stringp expr)
 (if (= (or width 1) 2)
 (format out "~&~10tld hl, (~a)" (z80-symbol expr))
 (format out "~&~10tld a, (~a)" (z80-symbol expr))))
 ((and (listp expr) (eq (first expr) :of))
 (let ((slot (second expr)) (obj (third expr)))
 (when (member obj '(:self "Self" self) :test #'equal)
 (format out "~&~10tld hl, (Self)")
 (format out "~&~10tld de, #~a" (slot-symbol slot slot-table class-id))
 ...
 (format out "~&~10tld hl, ~a" (z80-symbol (format nil "~a" (second expr))))
...
(defun compile-z80-move (out stmt class-id slot-table const-table pic-width-table)
 ...
 ((stringp to)
 (if (= (or to-w 1) 2)
 (format out "~&~10tld (~a), hl" (z80-symbol to))
 (format out "~&~10tld (~a), a" (z80-symbol to))))
 ...
 (format out "~&~10tld c, a")
 (format out "~&~10tld b, 0")
 (format out "~&~10tld hl, ~a" (z80-symbol (format nil "~a" (second to))))
 (format out "~&~10tadd hl, bc")
 (format out "~&~10tadd hl, bc")
 (format out "~&~10tpop de")
 (format out "~&~10tld (hl), e")
...
(defun compile-z80-invoke (out stmt class-id type-table pic-width-table)
 ...
 (if (= (or ret-w 1) 2)
 (format out "~&~10tld (~a), hl" (z80-symbol (format nil "~a" returning)))
 (format out "~&~10tld (~a), a" (z80-symbol (format nil "~a" returning)))))))))
...
(defun compile-z80-compute (out stmt class-id slot-table const-table pic-width-table)
 ...
 (if (= (or w 1) 2)
 (format out "~&~10tld (~a), hl" (z80-symbol (format nil "~a" target)))
 (format out "~&~10tld (~a), a" (z80-symbol (format nil "~a" target))))))
...
(defun compile-z80-set (out stmt class-id slot-table const-table pic-width-table)
 ...
 ((stringp target)
 (if (= (or w 1) 2)
 (format out "~&~10tld (~a), hl" (z80-symbol target))
 (format out "~&~10tld (~a), a" (z80-symbol target))))
 ...
 (format out "~&~10tex de, hl")
 (format out "~&~10tld hl, (Self)")
 (format out "~&~10tld bc, #~a" (slot-symbol slot slot-table class-id))
 (format out "~&~10tadd hl, bc")
 (format out "~&~10tld (hl), e")
 (format out "~&~10tinc hl")
 (format out "~&~10tld (hl), d"))
 ...
 (format out "~&~10tld c, a")
 (format out "~&~10tld b, 0")
 (format out "~&~10tld hl, ~a" (z80-symbol (format nil "~a" (second target))))
 (format out "~&~10tadd hl, bc")
 (format out "~&~10tadd hl, bc")
 (format out "~&~10tld (hl), e")
 (format out "~&~10tinc hl")
...
;;; ---------------------------------------------------------------
 ...
 length 64))
 (src-addr (z80-string-operand-address source))
