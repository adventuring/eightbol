...
(asdf:defsystem "optimizer-common-subexpression-elimination-tests"
  :description "common subexpression elimination optimizer pass tests"
  :author "EIGHTBOL Development"
  :version "0.1.0"
  :depends-on (:eightbol :fiveam)
  :components ((:module "optimizer-common-subexpression-elimination"
                :pathname "."
