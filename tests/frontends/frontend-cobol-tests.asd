...
(asdf:defsystem "frontend-cobol-tests"
  :description "COBOL frontend parser and lexer tests"
  :author "EIGHTBOL Development"
  :version "0.1.0"
  :depends-on (:eightbol :fiveam)
  :components ((:module "frontend-cobol"
                :pathname "."
                :components ((:file "package")
                             ...
                             (:file "copybook-tests" :depends-on ("package")))))
